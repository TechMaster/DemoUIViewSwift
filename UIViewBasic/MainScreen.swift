...
class MainScreen: UITableViewController {
    ...
    func onAbout(){
        var aler = UIAlertView(title: "About", message: self.about as String, delegate: self, cancelButtonTitle: "Thank")
        aler.show()
    }
    ...
    override func tableView(tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        var menuSection = self.menu[section]as! NSDictionary
        return menuSection[SECTION]as! NSString as String
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = item[TITLE] as! NSString as String
        return cell
    }
